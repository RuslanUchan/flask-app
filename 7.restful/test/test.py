...
class AllTests(unittest.TestCase):
    ...
    # if this method is commented out, it'll trigger IntegrityError
    def tearDown(self):
        db.session.remove()
        db.drop_all()
    ...
    def test_users_can_register(self):
        new_user = User('Chan', 'chanchanchan@chan.com', 'Uchanchan')
        db.session.add(new_user)
        db.session.commit()
    ...
    def test_users_can_login(self):
        self.register('DombaNdut', 'Domba@kambing.com', 'mbeeek', 'mbeeek')
        response = self.login('DombaNdut', 'mbeeek')
    ...
    def test_user_registration_error(self):
        ...
        response = self.register(
            'DombaNdut', 'Domba@kambing.com', 'mbeeek', 'mbeeek'
        )
        self.assertIn(
            b'Username and/or email already taken!',
            response.data
        )

    # Logging out
    def test_logged_in_users_can_logout(self):
        self.register('SapiMooo', 'Sapi@kebo.com', 'Mooooo', 'Mooooo')
        self.login('SapiMooo', 'Mooooo')
    ...
    def test_users_can_add_tasks(self):
        self.create_user('SapiMooo', 'Sapi@kebo.com', 'Mooooo')
        self.login('SapiMooo', 'Mooooo')
    ...
    # Tries to access task that is owned by other users
